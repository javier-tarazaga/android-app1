...
import com.tinygrip.android.presentation.view.area.presenter.NewAreaStep1Presenter;
...
public class NewAreaStep1Fragment extends BaseFragment implements NewAreaStep1View {
  ...
  @Inject NewAreaStep1Presenter newAreaStep1Presenter;

  @Bind(R.id.toolbar_new_area_step_1) Toolbar toolbar;
  ...
  @Override public void gotToNextStep() {
    if (this.newAreaStep1Listener != null) {
