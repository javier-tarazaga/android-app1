...
public class SettingsPresenter extends DefaultSubscriber<List<PreviewArea>> implements Presenter {
  ...
  private HomeView viewSettingsView;
  ...
  private void showViewLoading() {
    this.viewSettingsView.showLoading();
  }

  private void hideViewLoading() {
    this.viewSettingsView.hideLoading();
  }

  private void showViewRetry() {
    this.viewSettingsView.showRetry();
  }

  private void hideViewRetry() {
    this.viewSettingsView.hideRetry();
  }

  private void showErrorMessage(ErrorBundle errorBundle) {
    String errorMessage = ErrorMessageFactory.create(this.viewSettingsView.getContext(),
        errorBundle.getException());
    this.viewSettingsView.showError(errorMessage);
  }
  ...
  private final class UserListSubscriber extends DefaultSubscriber<List<User>> {
    ...
    @Override public void onError(Throwable e) {
      SettingsPresenter.this.hideViewLoading();
      SettingsPresenter.this.showErrorMessage(new DefaultErrorBundle((Exception) e));
      SettingsPresenter.this.showViewRetry();
    }
