...
public class NewAreaActivity extends BaseActivity implements HasComponent<AreaComponent>,
  ...
  @Override public void onBackStep1Clicked() {
    this.finish();
  }

  @Override public void onNextStepClicked() {
    replaceFragment(R.id.fl_fragment, NewAreaStep2Fragment.newInstance(), true);
  }

  @Override public void onBackStep2Clicked() {
    popFragmentBackStack();
  }

  @Override public void onSaveNewAreaClicked() {
